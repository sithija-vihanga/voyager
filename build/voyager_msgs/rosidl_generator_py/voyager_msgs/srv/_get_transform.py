...
class Metaclass_GetTransform_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('voyager_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from voyager_msgs.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from voyager_msgs.srv._get_transform import GetTransform_Request as Request
    from voyager_msgs.srv._get_transform import GetTransform_Response as Response
